            ...
            <div className="flex gap-6 justify-around py-6 flex-wrap">
                <div className="">
                    ...
                    <ul className='flex flex-col gap-2'>
                        ...
                        <li className='cursor-pointer'>NovaMart Science</li>
                    </ul>
                </div>
                <div className="">
                ...
                <div className="">
                    <h1 className="text-lg font-semibold text-white">Make Money with Us</h1>
                    <ul className='flex flex-col gap-2'>
                        <li className='cursor-pointer'>Sell on NovaMart</li>
                        <li className='cursor-pointer'>NovaMart Global Selling</li>
                        <li className='cursor-pointer'>Protect and Build Your Brand</li>
                        <li className='cursor-pointer'>Sell under NovaMart Accelerator</li>
                        <li className='cursor-pointer'>Become an Affiliate</li>
                        <li className='cursor-pointer'>Fulfilment by NovaMart</li>
                        <li className='cursor-pointer'>Advertise Your Products</li>
                        <li className='cursor-pointer'>NovaMart Pay on Merchants</li>
                    </ul>
                </div>
                <div className="">
                    <h1 className="text-lg font-semibold text-white">Let Us Help You</h1>
                    <ul className='flex flex-col gap-2'>
                        <li className='cursor-pointer'>100% Purchase Protection</li>
