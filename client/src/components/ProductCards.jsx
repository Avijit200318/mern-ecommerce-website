            ...
            <Link to={`/product/${product._id}`}>
                <div className="border border-black  w-64 p-3 flex flex-col gap-3 overflow-hidden">
                    ...
                    <div className="right px-1">
                        ...
                        <div className="flex gap-2 items-center"><span className="bg-orange-500 text-white px-1 text-sm font-semibold rounded-sm">{product.rating}&#9733;</span><span className='text-gray-500 font-semibold'>134 Ratings & 9 Reviews</span></div>
