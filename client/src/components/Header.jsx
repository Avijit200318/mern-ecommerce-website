    ...
    <header className=''>
      <div className="flex w-full justify-between items-center bg-[#0d6efd] px-10 py-2">
        ...
        <div className="allBtns flex justify-between items-center gap-4 text-white font-semibold">
          ...
          <span className='bg-red-600 w-[15px] h-[15px] rounded-full absolute top-[-4px] right-[-4px] flex items-center justify-center text-[0.7rem]'>{currentUser.cart.length}</span>
          </Link>
          {currentUser ? (
            <Link to='/profile'>
