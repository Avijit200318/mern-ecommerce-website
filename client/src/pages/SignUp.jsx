  ...
  return (
    <div className='flex justify-center items-center h-[90vh] bg-[#C5FFF8]'>
      <div className="w-[28rem] p-4 rounded-3xl shadow-2xl bg-white">
        ...
        <input type="text" placeholder='Username' id='username' className='px-4 py-3 rounded-lg  border-2 border-gray-300' autoComplete='off' />
          ...
          <button className="bg-blue-600 text-xl text-white font-semibold w-full py-2 rounded-lg transition-all duration-300 hover:bg-blue-500">Sign Up</button>
        </form>
